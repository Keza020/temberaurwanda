...
<nav class="bg-green-800 text-white px-8 py-4 flex items-center justify-between shadow-lg w-full">
     <img src="../assets/images/logo.png" alt="Logo" class="w-14 h-14 object-cover rounded-full"> 
     <span class="text-sm font-bold"> TEMBERA U RWANDA </span> 
          ...
          <li> <a href="/about" class="hover:text-yellow-300">About us</a> </li>
           ...
           <li> <a href="/services" class="hover:text-yellow-300">Services</a> </li>
            ...
            <ul class="invisible group-hover:visible opacity-0 group-hover:opacity-100 absolute bg-white text-green-900 rounded shadow w-48 top-full left-0 z-50">
                 <li><a href="/gallery" class="block px-4 py-2 hover:bg-green-200 text-green-900">Photos</a></li> 
                 <li><a href="/gallery" class="block px-4 py-2 hover:bg-green-200 text-green-900">Videos</a></li> 
                 </ul> </li> 
               
                   <li class="relative group">
                     <a href="/destinations" class="hover:text-yellow-300">Destinations<span>▾</span></a>

                      <ul class="invisible group-hover:visible opacity-0 group-hover:opacity-100 absolute bg-white text-green-900 rounded shadow w-48 top-full left-0 z-50">
                         <li><a href="/kigali" class="block px-4 py-2 hover:bg-green-200 
                              text-green-900">Kigali City</a>
                          </li> <li><a href="/northern" class="block px-4 py-2 hover:bg-green-200 text-green-900">Northern province</a></li> 
